...
//    document.write(`<div style="margin-bottom: 20px">${simpson["name"]} - ${simpson["surname"]} - ${simpson["age"]} - ${simpson["info"]}  <img src="${simpson["photo"]}" alt=""></div>`);
//}

// template2.2
// for (const simpson of simpsons) {
//    document.write(`<div class="style-main">
...
//    document.write(`<div class="shop-list">
//    <h3 class="shop-title">${product["title"]}. Price - ${product["price"]}</h3>
